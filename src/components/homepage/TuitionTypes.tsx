...
const tuitionTypes = [
  {
    id: 1,
    title: "Home Tutoring",
    description: "Personalized ,one-on-one Tutoring By verified experts ,Right at home.",
    icon: "🏠",
    color: "bg-blue-500",
  },
  {
    ...
    description: "Hire the best tutors online via Google Meet, Zoom and more.",
    icon: "💻",
    color: "bg-green-500",
  },
  {
    ...
    description: "Learn, solve, and grow together with affordable group sessions.",
    icon: "👥",
    color: "bg-purple-500",
  },
  {
